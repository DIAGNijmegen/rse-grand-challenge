...
def run():
    ...
    ChallengeRequest.objects.create(
        ...
        average_size_of_test_case_in_mb=fake.random_int(1, 1024),
        phase_1_number_of_submissions_per_team=fake.random_int(1, 10),
        phase_2_number_of_submissions_per_team=fake.random_int(1, 5),
        phase_1_number_of_test_cases=fake.random_int(1, 5),
        phase_2_number_of_test_cases=fake.random_int(50, 1000, 50),
        data_license=True,
